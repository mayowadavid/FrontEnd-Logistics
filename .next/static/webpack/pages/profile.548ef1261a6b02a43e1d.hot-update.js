...
var ClientContextProvider = function ClientContextProvider(props) {
  ...
  var handleProfileChange = function handleProfileChange(e) {
    ...
    if (e.target.files) {
      ...
      var filteredImageSize = error !== undefined || selected !== undefined ? selected.size < FileSize : setError("file too large *5mb minimum");
